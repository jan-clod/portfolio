...
let text1 = `Во времяобучения одним из серьезных проектов было создание социальной сети. За время разработки я освоил работу с различными библиотеками, такими как: Redux, redux-thunk, react-router-dom, Axios, materialUI, uuid, Yup, Formik. Приложение было написано с использованием TypeScript. На уровне обработки данных я использовал Redux. Данные, такие как пользователи, пользовательские сообщения, полученные с удаленного сервера с помощью запросов API, использовали библиотеку Axios для взаимодействия с сервером. Так же есть логин. Используемый компонент высшего порядка, компоненты контейнера, редьюсер, преобразователь. При разработке он придерживался таких принципов, как: не повторяйся, будь проще, глупее, принцип единой ответственности. Этот проект находится в разработке, но вы уже можете увидеть его по этой ссылке:  https://jan-clod.github.io/tsx-social-network-41week/ Также, используя вышеперечисленные навыки`
let href1 = 'https://jan-clod.github.io/tsx-social-network-41week/'
